...
# ==========================================================================================================
grid_numbers = [32, 16, 8, 5]
data_dir = r'data/Grid Size Filtering/'
for grid_num in grid_numbers:
    proj_name = f'{grid_num}grid-100000'
    ...
    dh = grid_num                  # Minimum cell width (meters)
    dom_width = 100000.0     # Total domain width (meters)
    ...
    np.savetxt('model_bf.dat',model)         # Save background model
    ...
    np.savetxt(t_fname, t_off)           # Save to custom filename
    ...
    s3time=time.time()
    np.savetxt(bz_fname, bz_SD.T)  # Save to custom filename
    ...
    etime = time.time()
    np.savetxt(dbz_fname, dbdt_SD_off)  # Save to custom filename
